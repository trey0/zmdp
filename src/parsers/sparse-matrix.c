...
/**********************************************************************/
I_Matrix_Row_Node addEntryToRow(I_Matrix_Row_Node row, int col, double value,
...
I_Matrix newIMatrix(int num_rows) {
  ...
  i_matrix->row =
      (I_Matrix_Row_Node *)calloc(num_rows, sizeof(*(i_matrix->row)));
...
/**********************************************************************/
int accumulateEntryInIMatrix(I_Matrix i_matrix, int row, int col,
                             double value) {
  /*
...
Matrix newMatrix(int num_rows, int num_non_zero) {
  ...
  matrix->mat_val = (double *)calloc(num_non_zero, sizeof(double));
  matrix->col = (int *)calloc(num_non_zero, sizeof(int));
  matrix->row_start = (int *)calloc(num_rows, sizeof(int));
  matrix->row_length = (int *)calloc(num_rows, sizeof(int));
...
Matrix transformIMatrix(I_Matrix i_matrix) {
  ...
  matrix = newMatrix(i_matrix->num_rows, countEntriesInIMatrix(i_matrix));
...
double sumRowValues(Matrix matrix, int row) {
  ...
  for (col = matrix->row_start[row];
       col < matrix->row_start[row] + matrix->row_length[row]; col++)
