...
extern I_Matrix_Row_Node addEntryToRow(I_Matrix_Row_Node row, int col,
                                       double value, int *count,
                                       int accumulate);
extern void displayRow(I_Matrix_Row_Node row);

extern int addEntryToIMatrix(I_Matrix i_matrix, int row, int col, double value);
extern int accumulateEntryInIMatrix(I_Matrix i_matrix, int row, int col,
                                    double value);
