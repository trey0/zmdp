...
void test_dvector(void) {
  ...
  cout << "  xd: size=" << xd.size() << " data=" << xd(0) << " " << xd(1) << " "
       << xd(2) << " " << xd(3) << endl;

  xd *= 2.0;
  cout << "--xd: data=2 4 6 8" << endl;
  cout << "  xd: data=" << xd(0) << " " << xd(1) << " " << xd(2) << " " << xd(3)
       << endl;
...
void test_cvector(void) {
  ...
  cout << "  xc: data=" << xc(0) << " " << xc(1) << " " << xc(2) << " " << xc(3)
       << endl;
...
void test_conversions(void) {
  ...
  cout << "  xc: size=" << xc.size() << " filled=" << xc.filled()
